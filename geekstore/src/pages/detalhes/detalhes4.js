    ...
    return (
        <div className="page-home">
            <div className="content">
                ...
                <p className="indice"> Home / Estátua Ellie Colecionador </p>
                ...
                <div className="detalhes_prod">
                    <p> Marca: Exemplo </p>
                    <h4 className="precoantigo"> <strike> De: R$499,99 </strike> </h4>
                ...
                <div className="informacoes">
                    ...
                    <table border="1" className="descricao">
                        <tr className="itemtable">
                            <th> Item </th>
                            <td className="celula"> Estátua Ellie Colecionador </td>                           
                        </tr>
                        <tr className="itemtable">
                            <th> Material </th>
