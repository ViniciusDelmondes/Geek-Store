    ...
    return (
        ...
        <div className="page-home">
            <div className="content" id="content">
                ...
                <p className="indice"> Home / Camiseta The Last of us part II </p>
                ...
                <div className="detalhes_prod">
                    <p> Marca: Exemplo </p>
                    <h4 className="precoantigo"> <strike> De: R$ 89,99 </strike> </h4>
                    <h2 className="precodetail"> R$ 69,99</h2>
                ...
                <div className="informacoes">
                    ...
                    <table border="1" className="descricao">
                        <tr className="itemtable">
                            <th> Item </th>
                            <td className="celula"> Camiseta The Last of us part II </td>                           
                        </tr>
                        <tr className="itemtable">
                            <th> Material </th>
