    ...
    return (
        <div className="page-home">
            <div className="content">
                ...
                <p className="indice"> Home / Xícara Superman Colecionador </p>
                ...
                <div className="detalhes_prod">
                    <p> Marca: Exemplo </p>
                    <h4 className="precoantigo"> <strike> De: R$35,99  </strike> </h4>
                    <h2 className="precodetail"> R$25,99 </h2>
                ...
                <div className="informacoes">
                    ...
                    <table border="1" className="descricao">
                        <tr className="itemtable">
                            <th> Item </th>
                            <td className="celula"> Funky Pop The 100 </td>                           
                        </tr>
                        <tr className="itemtable">
                            <th> Material </th>
                            <td className="celula"> Plástico </td>                           
                        </tr>
                        <tr className="itemtable">
                            <th> Dimensões </th>
                            <td className="celula"> 20cm / 20cm </td>                           
                        </tr>
                        <tr className="itemtable">
                            <th> Peso </th>
